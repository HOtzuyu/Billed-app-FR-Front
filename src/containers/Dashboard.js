...
export default class {
  ...
  handleShowTickets(e, bills, index) {
    ...
    bills.forEach(bill => {
      // fix #4 : [Bug Hunt] - Dashboard
      // Pour chaque ticket faire en sorte qu'il ne soit cliqué qu'une fois en fonction de son id
      // Ajout de .off(“click”) qui est un évènement jQuery La méthode .off() supprime les gestionnaires d'événements qui étaient attachés avec .on()
